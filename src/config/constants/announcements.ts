...
const announcements: Map<number, Announcement> = new Map([
  [
    141,
    {
      url: 'https://rugzombie.medium.com/celsius-grave-incoming-a7e3e4f8f1ab',
      title: 'Celsius Grave Incoming!',
      published: 1662436800,
    },
  ],
  [
    140,
    {
      url: 'https://rugzombie.medium.com/nomad-zombie-new-grave-with-16x-multiplier-743715b5dfc5',
      title: 'Nomad Zombie! New Grave with 16x Multiplier',
  ...
  [
    139,
    {
      url: 'https://rugzombie.medium.com/new-spawning-pool-imminent-ipunks-a9c60fa4eac7',
      title: 'New Spawning Pool: Imminent (iPunks)',
      published: 1661140800,
    },
  ],
  [
    138,
    {
      url: 'https://rugzombie.medium.com/main-street-is-back-in-the-spawning-pool-1cee53464245',
      title: 'Main Street is Back in the Spawning Pool',
      published: 1660536000,
    },
  ],
  [
    137,
