...
const nfts: Nft[] = [
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmTvbrG5QLaZXDiNvKAPjidvzzdbuwtKxtWVkSrnFb3iL9',
    type: 'image',
    rarity: 'Common',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmZJfGwdhFGY6ScYDoK1GLtJiDcNpvZUqKFrjk2koPSCYN',
    type: 'video',
    rarity: 'Common',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmXWRkphg4cZGeUr3pWME8esNmZWSiUg5pG9kq4iFSKFfy',
    type: 'video',
    rarity: 'Common',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmccqnhoPg8g8mVrMua5Fc2d3ZY8PLoAvEkFteFrVC9zkx',
    type: 'video',
    rarity: 'Uncommon',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmVDfVDfRHiTQ14gABKF7nHXZ2XmLXEyVJgxGyeq1u2Dvt',
    type: 'image',
    rarity: 'Biblical',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmRhksLK5YJjhSD1GssYL6czH1xdumKxUa4eQaN6AwDcyR',
    type: 'image',
    rarity: 'Biblical',
    userInfo: { ...DEFAULT_USER_INFO },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmXKNLfFf5wXizx6NhERq6CHbRdST544b6zoaTJyzzUniu',
    type: 'image',
    rarity: 'Rare',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmaTXD2A7dfTaMhGzDU9ubFwVS79GF9EPMRFkGc6G9XEHf',
    type: 'image',
    rarity: 'Legendary',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmXcs1Bpp3d16pF6HEKGmo4WTj8WU7YyaGi9b6F71StvDF',
    type: 'image',
    rarity: 'Common',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/Qmdi7wTt8iF62ay8foD7nqP5F7qSB9YGaYgY3NL1URA5Cw',
    type: 'image',
    rarity: 'Rare',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmcvagniUfh9k8Ks42pJPnDicHBGSkFgLB6dcUbJKnTB4p',
    type: 'image',
    rarity: 'Legendary',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmeRBJF6shwm23FrvCQ3SU69wWFcN3kJXNqseTxCyvi3LN',
    type: 'image',
    rarity: 'Common',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmVGjzRvf2WD5JKjh5wNVjVtimPv9R2mzeuYUNin2cFsc7',
    type: 'image',
    rarity: 'Legendary',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmafkchvcXFDdMkdJzQFjWaXcZQyGfe4F8p35X4TQVVGH3',
    type: 'image',
    rarity: 'Legendary',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmYvobX57rSxJE9LC2tgQhWKKirZQRmnfTHFy12tR8SQba',
    type: 'image',
    rarity: 'Legendary',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmSwn2nVZ7onSrh59LTtiC4o44Qbzzdk5eQFJkPB6wxbWw',
    type: 'image',
    rarity: 'Legendary',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmPiLdr6ZRieLFLYNRA2ch1PUr9aDqw7QAm832VZ9Texyj',
    type: 'image',
    rarity: 'Common',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmQnj8i4k2kwoboNN2TMoJ5ugH1Mxav4r8zAsz6PmXvP7P',
    type: 'image',
    rarity: 'Rare',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/Qmet1ztQoPXekbc8AK3VkxJK62CAQJC35weUKM6iz4Mn8s',
    type: 'image',
    rarity: 'Rare',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmdRJp1tPFNdg9WP1V1A3KTGYaF74zs6vT5yodhsn9FGcn',
    type: 'video',
    rarity: 'Legendary',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmbCfEW45ZFBXs1NgRHYyMXd2u9bUAeL8poHybZ1kP5oLY',
    type: 'image',
    rarity: 'Mythic',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmTKuQUr7t4rTmFCSm2kFD8azSK24ysUDWDKBDtHXnkhmT',
    type: 'image',
    rarity: 'Common',
    artist: artists.jussjoshinduh,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmcDG9auXhMRJdF9eaSMhrmcWeJe6kHrDAbYvDrVTYPaub',
    type: 'image',
    rarity: 'Uncommon',
    artist: artists.jussjoshinduh,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmW5KmNsBPHWfc8UBEMWvtQvVwM33UsBuiqqynjKftWSnX',
    type: 'image',
    rarity: 'Rare',
    artist: artists.jussjoshinduh,
    userInfo: { ...DEFAULT_USER_INFO },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmTUNZZSZZSbVtfvDkHFXPr9fuHdXYLnQeTJMTiRMJ7epq',
    type: 'video',
    rarity: 'Legendary',
    artist: artists.jussjoshinduh,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmNvGS6bxSueoyMHsxHtt7biEWCLZJ3o9TLHDR9hxHS7m1',
    type: 'image',
    rarity: 'Special',
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmRwEtpb8yxcWBTBCp7UFFH72R2c72fJP4swfjyTyJv7C4',
    type: 'image',
    rarity: 'Special',
    artist: artists.canadiancryptojunkie,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmRWcYPzZZt7Z1gk6VPZ9zJS7nAY8xxD6JX3ScdyrqyfR2',
    type: 'image',
    rarity: 'Special',
    artist: artists.canadiancryptojunkie,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmcGGXw3FiX61ALeZdSNyx2MKiquVZhF489jMJJto7rMLu',
    type: 'image',
    rarity: 'Special',
    artist: artists.canadiancryptojunkie,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmXXu2ThiBQf3GiUQMwSLoVk5e4ifhmZJSYzAAbUndj7fw',
    type: 'image',
    rarity: 'Special',
    artist: artists.none,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmYsk7hJcPAdvSEyQZd9aC3iWq1KCN6UHVsEGvbNifY5rn',
    type: 'image',
    rarity: 'Common',
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmVg8ZnNjqP2iXZLWuGACJ1aT9ehHkw8PuaJ4n8XtLccwn',
    type: 'image',
    rarity: 'Common',
    artist: artists.trippynazz,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmQ7C6m85qWCjBnMyMHeuhf8xgYwcKjzr2iihvgwi9Yk6T',
    type: 'image',
    rarity: 'Common',
    artist: artists.trippynazz,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmNqPjeXyruC29UdbQWF3dcWdZFZyv4E5BoTKs9aqmTCEo',
    type: 'image',
    rarity: 'Common',
    artist: artists.trippynazz,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/Qmazy6NjT8tExujfoqHDuA5RmWZ6xdrbNiFQKkVMiWLXVu',
    type: 'image',
    rarity: 'Uncommon',
    artist: artists.trippynazz,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmXsUgHfVLhTyiSk4VPbcr6iacEEDwo8KXfsK8tN4QXW55',
    type: 'image',
    rarity: 'Uncommon',
    artist: artists.trippynazz,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmZiTTWyAyru6Me4WvmvmcJSM1C6exeqiGcUTWkBUnwYUp',
    type: 'image',
    rarity: 'Rare',
    artist: artists.trippynazz,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmQ12QcVoJtuzGmf8zaqGyHnXWidnCSs6tqFRHASpbYnuf',
    type: 'image',
    rarity: 'Rare',
    artist: artists.canadiancryptojunkie,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmaJhr4tHsreMqQ81D5ni8iAApmpTm5EDtq8MEHFZDEqnt',
    type: 'image',
    rarity: 'Rare',
    userInfo: { ...DEFAULT_USER_INFO },
    artist: artists.jussjoshinduh,
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmdhptrGSeqm3ipgLEsFtRZ5oW7RZmoA1vMZHqfAtuGhfP',
    type: 'image',
    rarity: 'Rare',
    userInfo: { ...DEFAULT_USER_INFO },
    artist: artists.canadiancryptojunkie,
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmQ11oNLDfg7c3k1S6sfBEhcHWHtc9ykTQJhXhNU25fp7V',
    type: 'image',
    rarity: 'Legendary',
    userInfo: { ...DEFAULT_USER_INFO },
    artist: artists.canadiancryptojunkie,
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/Qme5fwhsG5sAHWg1yZUPYHqVj3wvZWetzpu5FWV4cmYHV3',
    type: 'image',
    rarity: 'Legendary',
    userInfo: { ...DEFAULT_USER_INFO },
    artist: artists.canadiancryptojunkie,
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmXNJtKYSRKNeoGDRgzfSjom69SJkGUVVz7gYUmnb5frHS',
    type: 'image',
    rarity: 'Rare',
    userInfo: { ...DEFAULT_USER_INFO },
    artist: artists.trippynazz,
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmXKBTHHpaSrhgtC67RT4JqkjDHaTJAsnYWfszcUUZfehM',
    type: 'image',
    rarity: 'Legendary',
    userInfo: { ...DEFAULT_USER_INFO },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmYjYvkES4PbSuBhUg5bwnrb4vAHJDDm3u3UMQ9H47Nfq2',
    type: 'image',
    rarity: 'Mythic',
    userInfo: { ...DEFAULT_USER_INFO },
    artist: artists.ayaz_psd,
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmZabZnzYQBVRoehCNtEUBSRUGferfRcuAjX8iz37c4VtL',
    type: 'image',
    rarity: 'Special',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmZW6MpQEfQqPXfHxJmfXYqxCoWHrM5PG27NbJWXnKgpnC',
    type: 'image',
    rarity: 'Special',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmdSGtvB9tScPDuNNEh8xWAChdKZfv5MhV4cUkWSgBxjNy',
    type: 'image',
    rarity: 'Legendary',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmZhgBBHipRXxMi8NqPxkSNEJWhTeF7XJ5FXxp3tYmcLAx',
    type: 'image',
    rarity: 'Rare',
    artist: artists.trippynazz,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmYQ1HBkRmxjwSvm6f8fK97jNX8VqynYGecBfJu84qa9eg',
    type: 'image',
    rarity: 'Rare',
    artist: artists.ZomBaes,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmYZZSJahiBKWUhwJMcgQT4xJYnqFjWWT1XQSUnPdhZseU',
    type: 'image',
    rarity: 'Common',
    artist: artists.canadiancryptojunkie,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/Qmbn35zChcRM5UWQFHwk4zF4bY9Ku4bq4YiW7qaamKkWsw',
    type: 'image',
    rarity: 'Common',
    artist: artists.jussjoshinduh,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmaAaAY5HnSGo4UAAwJ4N4DLR8JatkXirZzerdiF85QZ8w',
    type: 'image',
    rarity: 'Rare',
    artist: artists.jussjoshinduh,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmceY5i3QbqUFmxdxpd5FyZsHakHTH8LvY8ToLUste9xQJ',
    type: 'image',
    rarity: 'Legendary',
    artist: artists.ayaz_psd,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmUTqWeW63dXGh3StdSu2wM1TiwL4ce2NxWpwyMwFHSRXc',
    type: 'image',
    rarity: 'Common',
    artist: artists.canadiancryptojunkie,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmQD5L6kSgd2WgyydYadfc5vcd1AxjTzSDxJdmgnhSRFbJ',
    type: 'video',
    rarity: 'Legendary',
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmbbBroUEahSifTACYoPhA9fhQ1ZY42unhLzGrbD1egKgK',
    type: 'video',
    rarity: 'Biblical',
    artist: artists.none,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmZ5VSVdLqNZgJ6mhFFtP48xxr2Jc9jLQvJwi573eCnd7s',
    type: 'image',
    rarity: 'Rare',
    artist: artists.jussjoshinduh,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmW2HpTsZsRYM759q2o9j3qPbZH6oefCbt2iEYAkZnuYnG',
    type: 'image',
    rarity: 'Legendary',
    artist: artists.canadiancryptojunkie,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmQN5zX2NS3Yrj6VpxwHgoS83jDr5xuEFE4a1zZYpDe86m',
    type: 'image',
    rarity: 'Legendary',
    artist: artists.canadiancryptojunkie,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmUqZ6p2afdtjVQJQ6tHZVxW17NT9pPsUSGUePrk1vJzrN',
    type: 'video',
    rarity: 'Legendary',
    artist: artists.febryangraves,
    userInfo: { ...DEFAULT_USER_INFO },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/Qmdg19WTKxcbKA5KfZda2L797w6CqTwNhNiseMUMF345DQ',
    type: 'image',
    rarity: 'Rare',
    artist: artists.ayaz_psd,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    description: "",
    address: {
      56: '0x9DF3b88Fa324346a1937C554B81255a34180A211',
      97: '0x4f134fcFCe1476ebB8bA76Bd54524D1CfE59BDe6',
    },
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmUc7r4kAav8A3qYPmoU3DrXQBVDnXo96mBtm1V7nCXJbC',
    type: 'video',
    rarity: 'Legendary',
  ...
  {
    id: 92,
    name: 'Shiny Crypto Mutant Zombie',
    symbol: 'MUTANT',
    description: "",
    address: {
      56: '0x5B3d302D1b14ab9A5880A8BD3Eb274152D01717F',
      97: '0x4f134fcFCe1476ebB8bA76Bd54524D1CfE59BDe6',
    },
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmPTEnyNszqJJSVb9YPgxnXBAzUTWHKoRpXKcE4kQxLurb',
    type: 'video',
    rarity: 'Legendary',
  ...
  {
    id: 93,
    name: 'Dont Mess With Shiny Cthulhu',
    symbol: 'CTHULHU',
    description: "",
    address: {
      56: '0x4E178Dfd75d603B3933F6222ef8D1bd835baD6f8',
      97: '0x4f134fcFCe1476ebB8bA76Bd54524D1CfE59BDe6',
    },
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmVnEpNFCux5HGPoLeSepyyopjXqcw6wXGdmDDTsmzoAgU',
    type: 'video',
    rarity: 'Legendary',
    artist: artists.canadiancryptojunkie,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmR2KkjTGdFyShoQxAZ7DHJ25qP3ttbRqxZ8beJ6gbcUw4',
    type: 'image',
    rarity: 'Legendary',
    artist: artists.jussjoshinduh,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmYQ8fa8YcmjPt99NkJLZEFmv9Y3zevj29HB39RT5R6VJs',
    type: 'image',
    rarity: 'Special',
    artist: artists.rugzombie,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmYzVbVibR5TxwfndWiTZbxDRXbzRXam7dkj2ophTYMZ4Y',
    type: 'image',
    rarity: 'Uncommon',
    artist: artists.jussjoshinduh,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmNesjQkKpRJGE1qD71SihrSCKg2JfGySbjUpVkCFTC47d',
    type: 'image',
    rarity: 'Common',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmWxZBQdbokXE5gdfNHJBsxnwzS8tSbsayqvrgdZh6k1SX',
    type: 'image',
    rarity: 'Special',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmZyMmaT9Nt3xGosSWDZBAWUmj4u67cwMZJcwPHL3rPe1Q',
    type: 'image',
    rarity: 'Special',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmcUuCj9A9eUXf9tQ6Qk1iiWuZEz3HKjjCMidy9uDsw4Ae',
    type: 'image',
    rarity: 'Uncommon',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'http://ipfs.deadgames.io:8080/ipfs/QmSpuxcTm64dWq54UKFPiF48qkygG3HAnadxBiy8pFP5nB',
    type: 'image',
    rarity: 'Rare',
    artist: artists.jussjoshinduh,
    userInfo: { ...DEFAULT_USER_INFO },
  ...
  },
  {
    ...
    address: {
      56: '0x769Aa13441c2F5250ea57760d4A3D967B1Dfecfe',
      97: '0x4f134fcFCe1476ebB8bA76Bd54524D1CfE59BDe6',
    },
    totalSupply: BIG_ZERO,
    path: 'https://ipfs.io/ipfs/QmRe1snje7uXKA2mVdfoiqTQyj86K2dwYX1prSTrwbrJXb',
  ...
  },
  {
    ...
    description: "Outside of a dog, a book is man's best friend. Inside of a dog it's too dark to read.",
    address: {
      56: '0x4F3E770F745490f5b7a812F7Bf5558ea6f8A7235',
      97: '0x4f134fcFCe1476ebB8bA76Bd54524D1CfE59BDe6',
    },
    totalSupply: BIG_ZERO,
    path: 'https://ipfs.io/ipfs/QmRe1snje7uXKA2mVdfoiqTQyj86K2dwYX1prSTrwbrJXb',
  ...
  },
  {
    ...
    name: 'Groundbreaking',
    symbol: 'GRDBRK',
    description: "It’s Too Late For Sorry. Now You’re Grounded, Punk!",
    address: {
      56: '0xB39947E027f5bc8F76e1aF60a43389BfFC8A2e98',
      97: '0x4f134fcFCe1476ebB8bA76Bd54524D1CfE59BDe6',
    },
    totalSupply: BIG_ZERO,
    type: 'image',
  ...
  },
  {
    ...
    name: 'Eternal Monkey',
    symbol: 'ETERNAL',
    description: "This monkey will never die.",
    address: {
      56: '0xc87867a9D51548bDa876450a86A5e633baCC8E22',
      97: '0x4f134fcFCe1476ebB8bA76Bd54524D1CfE59BDe6',
    },
    totalSupply: BIG_ZERO,
    type: 'image',
