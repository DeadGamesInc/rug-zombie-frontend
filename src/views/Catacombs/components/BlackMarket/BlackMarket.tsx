...
const BlackMarket: React.FC = () => {
  ...
  useEffect(() => {
    rugMarketContract.events.ListingAdded({}, (error, event) => {
  ...
  useEffect(() => {
    rugMarketContract.events.ListingCancelled({}, (error, event) => {
      if (event?.returnValues) {
  ...
  useEffect(() => {
    rugMarketContract.events.ListingSold({}, (error, event) => {
      if (event?.returnValues) {
